...
;(function(window, document, undefined) {
  ...
  function modalDependant() {
    ...
    if (!previousDocumentClick) previousDocumentClick = document.onclick;
    ...
    if (!previousWindowKeyDown) previousWindowKeyDown = window.onkeydown;
    ...
    function handleOnBlur(event) {
      ...
      if (modalIsVisible && typeof $focusElement != 'undefined') {
        var btnIndex = -1; // Find the button - note, this is a nodelist, not an array.
    ...
    if (!previousWindowOnFocus) previousWindowOnFocus = window.onfocus;
