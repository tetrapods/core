...
public class ValidateConnectionRequest extends RequestWithResponse<ValidateConnectionResponse>  {
   ...
   public static interface Handler2 {
      @RequestClass(ValidateConnectionRequest.class)
      Task<ValidateConnectionResponse> validateConnection(int entityId, String token);
   }
