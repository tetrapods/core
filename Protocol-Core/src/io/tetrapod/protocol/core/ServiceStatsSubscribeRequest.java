...
public class ServiceStatsSubscribeRequest extends Request  {
   ...
   public ServiceStatsSubscribeRequest(int accountId, String authToken) {
   ...
   public static interface Handler2 {
      @RequestClass(ServiceStatsSubscribeRequest.class)
      Task<Response> serviceStatsSubscribe(int accountId, String authToken);
   }
