...
public class ShutdownRequest extends Request  {
   ...
   public ShutdownRequest(int accountId, String authToken) {
   ...
   public final int getContractId() {
      return ShutdownRequest.CONTRACT_ID;
   }

   public final int getSubContractId() {
      return ShutdownRequest.SUB_CONTRACT_ID;
   }
   ...
   public static interface Handler2 {
      @RequestClass(ShutdownRequest.class)
      Task<Response> shutdown(int accountId, String authToken);
   }
