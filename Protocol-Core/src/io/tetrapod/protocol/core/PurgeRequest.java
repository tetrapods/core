...
public class PurgeRequest extends Request  {
   ...
   public PurgeRequest(int accountId, String authToken) {
   ...
   public final int getStructId() {
      return PurgeRequest.STRUCT_ID;
   }
   
   @Override
   public final Response dispatch(ServiceAPI is, RequestContext ctx) {
      if (is instanceof Handler)
         return ((Handler)is).requestPurge(this, ctx);
      return is.genericRequest(this, ctx);
   }
   
   public static interface Handler extends ServiceAPI {
      Response requestPurge(PurgeRequest r, RequestContext ctx);
   }

   public static interface Handler2 {
      @RequestClass(PurgeRequest.class)
      Task<Response> purge(int accountId, String authToken);
   }
