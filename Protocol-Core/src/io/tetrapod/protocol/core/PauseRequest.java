...
public class PauseRequest extends Request  {
   ...
   public PauseRequest(int accountId, String authToken) {
   ...
   public final int getSubContractId() {
      return PauseRequest.SUB_CONTRACT_ID;
   }
   ...
   public static interface Handler2 {
      @RequestClass(PauseRequest.class)
      Task<Response> pause(int accountId, String authToken);
   }
