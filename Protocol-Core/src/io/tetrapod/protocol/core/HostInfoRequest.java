...
public class HostInfoRequest extends RequestWithResponse<HostInfoResponse>  {
   ...
   public HostInfoRequest() {
      defaults();
   }

   public HostInfoRequest(int accountId, String authToken) {
   ...
   public final int getContractId() {
      return HostInfoRequest.CONTRACT_ID;
   }

   public final int getSubContractId() {
      return HostInfoRequest.SUB_CONTRACT_ID;
   }

   public final int getStructId() {
      return HostInfoRequest.STRUCT_ID;
   }
   
   @Override
   public final Response dispatch(ServiceAPI is, RequestContext ctx) {
      if (is instanceof Handler)
         return ((Handler)is).requestHostInfo(this, ctx);
      return is.genericRequest(this, ctx);
   }
   
   public static interface Handler extends ServiceAPI {
      Response requestHostInfo(HostInfoRequest r, RequestContext ctx);
   }

   public static interface Handler2 {
      @RequestClass(HostInfoRequest.class)
      Task<HostInfoResponse> hostInfo(int accountId, String authToken);
   }
   ...
   public final Structure make() {
      return new HostInfoRequest();
   }
   
   public final StructDescription makeDescription() {
      StructDescription desc = new StructDescription();      
      desc.name = "HostInfoRequest";
