...
public class HostStatsRequest extends RequestWithResponse<HostStatsResponse>  {
   ...
   public HostStatsRequest() {
      defaults();
   }

   public HostStatsRequest(int accountId, String authToken) {
   ...
   public final int getContractId() {
      return HostStatsRequest.CONTRACT_ID;
   }

   public final int getSubContractId() {
      return HostStatsRequest.SUB_CONTRACT_ID;
   }

   public final int getStructId() {
      return HostStatsRequest.STRUCT_ID;
   }
   
   @Override
   public final Response dispatch(ServiceAPI is, RequestContext ctx) {
      if (is instanceof Handler)
         return ((Handler)is).requestHostStats(this, ctx);
      return is.genericRequest(this, ctx);
   }
   
   public static interface Handler extends ServiceAPI {
      Response requestHostStats(HostStatsRequest r, RequestContext ctx);
   }

   public static interface Handler2 {
      @RequestClass(HostStatsRequest.class)
      Task<HostStatsResponse> hostStats(int accountId, String authToken);
   }
   ...
   public final Structure make() {
      return new HostStatsRequest();
   }
   
   public final StructDescription makeDescription() {
      StructDescription desc = new StructDescription();      
      desc.name = "HostStatsRequest";
