...
public class RebalanceRequest extends Request  {
   ...
   public static final int STRUCT_ID = 1734199;
   ...
   public RebalanceRequest(int accountId, String authToken) {
   ...
   public final int getContractId() {
      return RebalanceRequest.CONTRACT_ID;
   }

   public final int getSubContractId() {
      return RebalanceRequest.SUB_CONTRACT_ID;
   }

   public final int getStructId() {
      return RebalanceRequest.STRUCT_ID;
   }
   
   @Override
   public final Response dispatch(ServiceAPI is, RequestContext ctx) {
      if (is instanceof Handler)
         return ((Handler)is).requestRebalance(this, ctx);
      return is.genericRequest(this, ctx);
   }
   
   public static interface Handler extends ServiceAPI {
      Response requestRebalance(RebalanceRequest r, RequestContext ctx);
   }

   public static interface Handler2 {
      @RequestClass(RebalanceRequest.class)
      Task<Response> rebalance(int accountId, String authToken);
   }
