...
public class ServiceRequestStatsRequest extends Request {
   ...
   public ServiceRequestStatsRequest(String token, String domain, int limit, long minTime, RequestStatsSort sortBy) {
      this.token = token;
      this.domain = domain;
      this.limit = limit;
   ...
   public final void write(DataSource data) throws IOException {
      ...
      data.write(2, this.domain);
      data.write(3, this.limit);
      data.write(4, this.minTime);
      if (this.sortBy != null) data.write(5, this.sortBy.value);
      data.writeEndTag();
   }
   ...
   public final void read(DataSource data) throws IOException {
      ...
      while (true) {
         ...
         switch (tag) {
            ...
            case 2: this.domain = data.read_string(tag); break;
            case 3: this.limit = data.read_int(tag); break;
            case 4: this.minTime = data.read_long(tag); break;
            case 5: this.sortBy = RequestStatsSort.from(data.read_int(tag)); break;
            case Codec.END_TAG:
               return;
            default:
               data.skip(tag);
