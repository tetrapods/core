...
public class ResetServiceErrorLogsRequest extends Request  {
   ...
   public ResetServiceErrorLogsRequest(int accountId, String authToken) {
   ...
   public final int getSubContractId() {
      return ResetServiceErrorLogsRequest.SUB_CONTRACT_ID;
   }
   ...
   public static interface Handler2 {
      @RequestClass(ResetServiceErrorLogsRequest.class)
      Task<Response> resetServiceErrorLogs(int accountId, String authToken);
   }
