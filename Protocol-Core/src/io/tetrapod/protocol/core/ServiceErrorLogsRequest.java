...
public class ServiceErrorLogsRequest extends RequestWithResponse<ServiceErrorLogsResponse>  {
   ...
   public ServiceErrorLogsRequest(int accountId, String authToken) {
   ...
   public final int getStructId() {
      return ServiceErrorLogsRequest.STRUCT_ID;
   }
   
   @Override
   public final Response dispatch(ServiceAPI is, RequestContext ctx) {
      if (is instanceof Handler)
         return ((Handler)is).requestServiceErrorLogs(this, ctx);
      return is.genericRequest(this, ctx);
   }
   
   public static interface Handler extends ServiceAPI {
      Response requestServiceErrorLogs(ServiceErrorLogsRequest r, RequestContext ctx);
   }

   public static interface Handler2 {
      @RequestClass(ServiceErrorLogsRequest.class)
      Task<ServiceErrorLogsResponse> serviceErrorLogs(int accountId, String authToken);
   }
   ...
   public final Structure make() {
      return new ServiceErrorLogsRequest();
   }
   
   public final StructDescription makeDescription() {
      StructDescription desc = new StructDescription();      
      desc.name = "ServiceErrorLogsRequest";
