...
public class OtherUpdateMessage extends Message {
   
   public static final int STRUCT_ID = 5060269;
   public static final int CONTRACT_ID = SampleContract.CONTRACT_ID;
    
   public OtherUpdateMessage() {
      defaults();
   }

   public OtherUpdateMessage(int accountId, String name) {
   ...
   public final int getContractId() {
      return OtherUpdateMessage.CONTRACT_ID;
   }

   public final int getStructId() {
      return OtherUpdateMessage.STRUCT_ID;
   }
   
   @Override
   public final void dispatch(SubscriptionAPI api, MessageContext ctx) {
      if (api instanceof Handler)
         ((Handler)api).messageOtherUpdate(this, ctx);
      else
         api.genericMessage(this, ctx);
   }
   
   public static interface Handler extends SubscriptionAPI {
      void messageOtherUpdate(OtherUpdateMessage m, MessageContext ctx);
   }
