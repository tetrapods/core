...
public class StorageGetResponse extends Response {
   ...
   public StorageGetResponse(String value) {
      this.value = value;
   }   
   ...
   public final void read(DataSource data) throws IOException {
      ...
      while (true) {
         ...
         switch (tag) {
            case 1: this.value = data.read_string(tag); break;
            case Codec.END_TAG:
               return;
            default:
               data.skip(tag);
   ...
   public final int getStructId() {
      return StorageGetResponse.STRUCT_ID;
   }
