...
public class RaftStatsRequest extends RequestWithResponse<RaftStatsResponse>  {
   ...
   public RaftStatsRequest(int accountId, String authToken) {
   ...
   public final int getSubContractId() {
      return RaftStatsRequest.SUB_CONTRACT_ID;
   }
   ...
   public static interface Handler2 {
      @RequestClass(RaftStatsRequest.class)
      Task<RaftStatsResponse> raftStats(int accountId, String authToken);
   }
