...
public class DelWebRootRequest extends Request  {
   ...
   public DelWebRootRequest(int accountId, String authToken, String name) {
   ...
   public final int getSubContractId() {
      return DelWebRootRequest.SUB_CONTRACT_ID;
   }
   ...
   public static interface Handler2 {
      @RequestClass(DelWebRootRequest.class)
      Task<Response> delWebRoot(int accountId, String authToken, String name);
   }
