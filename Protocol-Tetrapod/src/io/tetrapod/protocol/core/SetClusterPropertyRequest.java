...
public class SetClusterPropertyRequest extends Request  {
   ...
   public final int getSubContractId() {
      return SetClusterPropertyRequest.SUB_CONTRACT_ID;
   }
   ...
   public static interface Handler2 {
      @RequestClass(SetClusterPropertyRequest.class)
      Task<Response> setClusterProperty(int accountId, String authToken, ClusterProperty property);
   }
