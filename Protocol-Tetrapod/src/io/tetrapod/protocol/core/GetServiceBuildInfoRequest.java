...
public class GetServiceBuildInfoRequest extends RequestWithResponse<GetServiceBuildInfoResponse>  {
   ...
   public GetServiceBuildInfoRequest(int accountId, String authToken) {
   ...
   public final Response dispatch(ServiceAPI is, RequestContext ctx) {
      if (is instanceof Handler)
         return ((Handler)is).requestGetServiceBuildInfo(this, ctx);
      return is.genericRequest(this, ctx);
   }
   
   public static interface Handler extends ServiceAPI {
      Response requestGetServiceBuildInfo(GetServiceBuildInfoRequest r, RequestContext ctx);
   }

   public static interface Handler2 {
      @RequestClass(GetServiceBuildInfoRequest.class)
      Task<GetServiceBuildInfoResponse> getServiceBuildInfo(int accountId, String authToken);
   }
   ...
   public final Structure make() {
      return new GetServiceBuildInfoRequest();
   }
   
   public final StructDescription makeDescription() {
      StructDescription desc = new StructDescription();      
      desc.name = "GetServiceBuildInfoRequest";
