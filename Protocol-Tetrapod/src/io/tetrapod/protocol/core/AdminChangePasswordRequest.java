...
public class AdminChangePasswordRequest extends Request  {
   ...
   public static interface Handler2 {
      @RequestClass(AdminChangePasswordRequest.class)
      Task<Response> adminChangePassword(int accountId, String authToken, String oldPassword, String newPassword);
   }
   ...
   public final StructDescription makeDescription() {
      ...
      desc.name = "AdminChangePasswordRequest";
