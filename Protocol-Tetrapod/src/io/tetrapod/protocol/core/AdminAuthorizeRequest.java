...
public class AdminAuthorizeRequest extends RequestWithResponse<AdminAuthorizeResponse>  {
   ...
   public final int getSubContractId() {
      return AdminAuthorizeRequest.SUB_CONTRACT_ID;
   }
   ...
   public static interface Handler2 {
      @RequestClass(AdminAuthorizeRequest.class)
      Task<AdminAuthorizeResponse> adminAuthorize(String token);
   }
