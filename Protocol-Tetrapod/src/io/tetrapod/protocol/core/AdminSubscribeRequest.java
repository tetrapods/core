...
public class AdminSubscribeRequest extends RequestWithResponse<AdminSubscribeResponse>  {
   ...
   public AdminSubscribeRequest(int accountId, String authToken) {
   ...
   public static interface Handler2 {
      @RequestClass(AdminSubscribeRequest.class)
      Task<AdminSubscribeResponse> adminSubscribe(int accountId, String authToken);
   }
   ...
   public final StructDescription makeDescription() {
      ...
      desc.name = "AdminSubscribeRequest";
