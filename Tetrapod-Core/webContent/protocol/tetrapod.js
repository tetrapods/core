...
TP.registerConst("Identity", "Identity", "AUTH_TOKEN_USER", 1);
TP.registerConst("Identity", "Identity", "AUTH_TOKEN_APP_1", 2);
TP.registerConst("Identity", "Identity", "AUTH_TOKEN_APP_2", 3);
TP.registerConst("Identity", "Identity", "AUTH_TOKEN_APP_3", 4);
...
TP.registerConst("Identity", "User", "PROPS_NO_PASSWORD", 256);

TP.register("struct", "BaseService", "ServiceCommand", 2, 5461687);
...
TP.register("request", "BaseService", "ServiceDetails", 2, 14458441);
TP.register("response", "BaseService", "ServiceDetails", 2, 12435407);
TP.register("request", "BaseService", "ServiceStatsSubscribe", 2, 13519504);
TP.register("request", "BaseService", "ServiceStatsUnsubscribe", 2, 576067);
TP.register("message", "BaseService", "ServiceStats", 2, 469976);
...
TP.register("request", "Tetrapod", "LogRegistryStats", 1, 10504592);
...
TP.register("request", "Identity", "TokenLogin", 4, 11214546);
TP.register("response", "Identity", "TokenLogin", 4, 15005038);
...
TP.register("request", "Identity", "AddUnverifiedUser", 4, 3799907);
TP.register("response", "Identity", "AddUnverifiedUser", 4, 415825);
