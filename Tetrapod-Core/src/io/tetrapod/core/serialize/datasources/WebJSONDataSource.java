...
/**
 * Uses the webTagNames for json serialization instead of just the tag itself.  Although a lot
 * prettier this format is not recommended for long term storage as people are free to rename
 * their fields but are not free to rename the tags.
 */
