...
public class TestRequest extends Request {
   ...
   /**
    * genned comments do attach to constants
    */
   public static final int MY_CONST = 1223; 
   public static final int MY_OTHER_CONST = 0x2234; 
   
   public static final int STRUCT_ID = 998;
   ...
   public TestRequest(int intval, double doubleval, boolean boolval, long longval, byte byteval, String stringval, int[] intarray, List<Integer> intlist, TestInfo info, List<TestInfo> infolist, TestInfo[] infoarray) {
      this.intval = intval;
   ...
   public final int getContractId() {
      return TestRequest.CONTRACT_ID;
   }

   public final int getStructId() {
      return TestRequest.STRUCT_ID;
   }
   
   @Override
   public final Response dispatch(ServiceAPI is, RequestContext ctx) {
      if (is instanceof Handler)
         return ((Handler)is).requestTest(this, ctx);
      return is.genericRequest(this, ctx);
   }
   
   public static interface Handler extends ServiceAPI {
      Response requestTest(TestRequest r, RequestContext ctx);
   }
